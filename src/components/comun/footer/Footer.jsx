...
const Footer = () => {
    ...
    return (
        ...
        <div className="principal-footer-container bg-black text-[#e3e3db] py-20 px-5 md:px-10 flex flex-col items-center w-full box-border min-h-[50vh]" ref={footerRef}>
            ...
            <div className="progress-bar-container w-[90%] h-[3px] bg-[#333] relative overflow-hidden my-16">
                <div className="progress-bar absolute top-0 left-0 h-full w-0 bg-[#f93535]" ref={progressBarRef}></div>
            </div>
            ...
            <div className="footer-content flex flex-col items-center w-full max-w-screen-xl px-4 md:px-0"> 
                ...
                <div className="flex flex-col md:flex-row justify-center"> 
                    ...
                    <div className="footer-col flex flex-col items-center mb-12 md:mb-0"> 
                        <p className="text-4xl font-bold text-white font-barlow-condensed leading-none mb-8">GIA</p> 
                        <img src="/logo-pucp.png" alt="PUCP Logo" className="w-[150px] h-auto filter brightness-0 invert" />
                    </div>

                    {/* COLUMNA 2: Contacto + Detalles */}
                    {/* footer-col define el ancho de la columna */}
                    <div className="footer-col flex flex-col items-center mb-12 md:mb-0">
                        <h3 className="text-xl md:text-2xl font-bold text-white font-barlow-condensed mb-8">Contacto</h3>
                        <p className="text-base md:text-lg leading-relaxed mb-2 font-barlow-condensed">grupo.gia@pucp.edu.pe</p>
                        <p className="text-base md:text-lg leading-relaxed mb-2 font-barlow-condensed">+51 972285288</p>
                    ...
                    <div className="footer-col flex flex-col items-center">
                        <h3 className="text-xl md:text-2xl font-bold text-white font-barlow-condensed mb-8">Redes</h3>
                        <div className="social-icons flex gap-6 justify-center mt-2">
                            <a href="https://www.instagram.com/gia_pucp/" target="_blank" rel="noopener noreferrer" 
                                className="transition-transform duration-300 hover:-translate-y-1">
                                <FaInstagram size={35} style={{ color: '#E4405F' }} /> 
                            </a>
                            <a href="https://www.linkedin.com/company/gia-at-pucp/" target="_blank" rel="noopener noreferrer"
                                className="transition-transform duration-300 hover:-translate-y-1">
